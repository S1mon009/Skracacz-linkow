...
})()(
  {
    ...
    2: [
      function (require, module, exports) {
        ...
        const inputLongInput = document.querySelector(".long-input");
        const inputShortLink = document.querySelector(".short-link");
        const linkBtn = document.querySelector(".get-link");
        ...
        async function getLink(link) {
          try {
            const shortLink = await gotiny.set(link);
            linkIcon.innerHTML = "";
            linkIcon.innerHTML = '<i class="fa-solid fa-link"></i>';
            inputShortLink.value = shortLink[0].link;
            copyBtn.disabled = false;
          } catch (err) {
            linkIcon.innerHTML = "";
            linkIcon.innerHTML = '<i class="fa-solid fa-link-slash"></i>';
            inputShortLink.value = "Nie można znaleźć linku";
        ...
        function copyToClipboard() {
          ...
          inputShortLink.setSelectionRange(0, 9999);
          navigator.clipboard.writeText(inputShortLink.value);

          copyText.classList.remove("none");

          setTimeout(() => copyText.classList.add("none"), 3000);
        }

        linkBtn.addEventListener("click", function (e) {
          e.preventDefault();
          getLink(inputLongInput.value);
        });
    ...
    11: [
      ...
      { "../helpers/combineURLs": 21, "../helpers/isAbsoluteURL": 23 },
    ],
    12: [
      function (require, module, exports) {
        "use strict";
    ...
    32: [
      function (require, module, exports) {
        ...
        const set_1 = __importDefault(require("./main/set"));
        const get_1 = __importDefault(require("./main/get"));
        module.exports = { set: set_1.default, get: get_1.default };
      },
      { "./main/get": 33, "./main/set": 34 },
    ],
    33: [
      function (require, module, exports) {
        "use strict";
